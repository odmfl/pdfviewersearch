    ...
    public void setupLayout(PDFView pdfView) {
        ...
        if (pdfView.isSwipeVertical()) {
            ...
            if (inverted) { // left
                ...
                background = context.getDrawable(R.drawable.default_scroll_handle_left);
            } else { // right
                align = ALIGN_PARENT_RIGHT;
                background = context.getDrawable(R.drawable.default_scroll_handle_right);
//                background = getDrawable(context, R.drawable.default_scroll_handle_right);
            }
        } else {
            width = HANDLE_SHORT;
            height = HANDLE_LONG;
            if (inverted) { // top
                ...
                background = context.getDrawable(R.drawable.default_scroll_handle_top);
//                background = context.getDrawable(context, R.drawable.default_scroll_handle_top);
            } else { // bottom
                align = ALIGN_PARENT_BOTTOM;
                background = context.getDrawable(R.drawable.default_scroll_handle_bottom);
//                background = context.getDrawable(context, R.drawable.default_scroll_handle_bottom);
            }
        }
