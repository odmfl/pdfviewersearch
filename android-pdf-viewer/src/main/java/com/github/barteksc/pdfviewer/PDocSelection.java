...
public class PDocSelection extends View {
    ...
    public PDocSelection(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public PDocSelection(Context context, AttributeSet attrs, int defStyleAttr) {
                    ...
                    for (int j = 0, len = data.size(); j < len; j++) {
                        ...
                        if (rects != null) {
                            for (RectF rI : rects) {
                                ...
                                VR.set(-5, -5, bmWidth + 5, bmHeight + 5);
