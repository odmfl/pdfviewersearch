...
public class PdfiumCore {
    ...
    public native long nativeOpenDocument(int fd, String password);

    public native long nativeOpenMemDocument(byte[] data, String password);

    public native void nativeCloseDocument(long docPtr);

    public native int nativeGetPageCount(long docPtr);

    public native long nativeLoadPage(long docPtr, int pageIndex);

    public native long[] nativeLoadPages(long docPtr, int fromIndex, int toIndex);

    public native void nativeClosePage(long pagePtr);
    ...
    /**
     * Open page and store native pointer in {@link com.shockwave.pdfium.PdfDocument}
     */
     ...
     * Page must be opened before rendering.
     * <p>
     * For more info see {@link PdfiumCore#renderPageBitmap(com.shockwave.pdfium.PdfDocument, Bitmap, int, int, int, int, int)}
     */
    public void renderPageBitmap(PdfDocument doc, Bitmap bitmap, int pageIndex,
                                 int startX, int startY, int drawSizeX, int drawSizeY,
                                 boolean renderAnnot) {
    ...
    /**
     * @return mapped coordinates
     * @see PdfiumCore#mapPageCoordsToDevice(com.shockwave.pdfium.PdfDocument, int, int, int, int, int, int, double, double)
     */
